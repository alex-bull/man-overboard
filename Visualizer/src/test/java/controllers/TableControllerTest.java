...
public class TableControllerTest {
    ...
    public void setTable() throws Exception {
        ...
        when(boat1.getLegIndex()).thenReturn(1);
        competitors.add(boat1);
        Boat boat2=mock(Boat.class);
        when(boat2.getLegIndex()).thenReturn(1);
        ...
        when(boat3.getLegIndex()).thenReturn(1);
        competitors.add(boat3);
        Boat boat4=mock(Boat.class);
        when(boat4.getLegIndex()).thenReturn(1);
        ...
        when(boat5.getLegIndex()).thenReturn(1);
        competitors.add(boat5);
        Boat boat6=mock(Boat.class);
        when(boat6.getLegIndex()).thenReturn(1);
        ...
        //new order
        when(boat4.getLegIndex()).thenReturn(2);
        when(boat5.getLegIndex()).thenReturn(2);
        when(boat6.getLegIndex()).thenReturn(2);
        tableController.setTable(competitors);
        tableController.printTable();
        //new order
        when(boat1.getLegIndex()).thenReturn(2);
        when(boat2.getLegIndex()).thenReturn(2);
        when(boat3.getLegIndex()).thenReturn(2);
        tableController.setTable(competitors);
        tableController.printTable();
