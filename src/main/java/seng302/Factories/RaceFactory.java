...
public class RaceFactory {
    ...
    public Race createRace(int numBoats, int raceDuration, Course raceCourse) {
        ...
        competitors.add(new Boat("Emirates Team New Zealand", 22, new MutablePoint(30.0, 0.0), Color.RED,"NZL"));
        ...
        competitors.add(new Boat("Artemis Racing", 14, new MutablePoint(150.0, 0.0), Color.GREEN,"SWE"));
