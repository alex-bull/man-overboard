...
public class MatchRaceTest {
    ...
    public void createDependencies () {
        ...
        competitors.add(new Boat("Emirates Team New Zealand", 19, new MutablePoint(0.0, 0.0)));
        competitors.add(new Boat("Ben Ainslie Racing", 18,  new MutablePoint(-10.0, 0.0)));
        competitors.add(new Boat("SoftBank Team Japan", 17,  new MutablePoint(-10.0, 0.0)));
        competitors.add(new Boat("Team France", 16,  new MutablePoint(-20.0, 0.0)));
        competitors.add(new Boat("Artemis Racing", 15,  new MutablePoint(-11.0, 0.0)));
