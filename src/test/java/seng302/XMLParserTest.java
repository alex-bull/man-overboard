...
public class XMLParserTest {
    ...
    points.add(new Gate("Startline", new Point(32.296577,-64.854304), new Point(32.293771,-64.855242), true));
    points.add(new Mark("Marker", new Point(32.293771,-64.855242),false));
